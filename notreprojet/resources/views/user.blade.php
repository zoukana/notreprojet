                   ...
                   {{--  <span class="col-1 ">
                    ...
                    <div class="ml-auto  mt-3 " style="margin-left:auto;max-height: 2.5rem;">
                        <form class="d-flex" action="/search" method="GET" role="search">
                            <input class="form-control me-2" name="q" type="search" placeholder="Recherche"
                                aria-label="Search">
                            <button class="btn btn-outline-secondary text-dark" type="submit">Search</button>
                        </form> --}}
{{--                         <div class="container mt-5">
                            <div classs="form-group">
                                <input type="text" id="search" name="search"  class="form-control " keyup='searchTask' v-model='q' placeholder="Search">
                            </div>
                        </div>
                        
                    </div> --}}
                   {{--  @if(all($users)>2 && count()>0)
                        <div>
                            @if(count($users)>0)
                        ...
                        @else
                            <span>0 resultats pour "{{$users }}"</span>
                    @endif --}}
