...
<html>
    ...
    <body>
     <div class="container">
      <br />
      <h3 text-align="center">Insert Image into Mysql Database in Laravel 6</h3>
        <br />
        @if($errors->any())
        ...
        <div class="panel panel-default">
             ...
             <form method="post" action="{{ url('store_image/insert_image') }}"  enctype="multipart/form-data">
              ...
              <div class="row">
               <label class="col-md-4" text-align="right">Enter Name</label>
               <div class="col-md-8">
             ...
             <div class="form-group">
              <div class="row">
               <label class="col-md-4" text-align="right">Select Profile Image</label>
               <div class="col-md-8">
